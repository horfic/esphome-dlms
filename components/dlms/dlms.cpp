...
//      ESP_LOGD(TAG, "SML Data export power: %i", ExportPower);
      ...
      ESP_LOGI(TAG, "SML Data TotalEnergyConsumed: %fkWh", TotalEnergyConsumed / 1000);

      TotalEnergyConsumedTarif1 = sml_data[56] << 24 | sml_data[57] << 16 | sml_data[58] << 8 | sml_data[59]; // [KWh]
      ESP_LOGI(TAG, "SML Data TotalEnergyConsumedTarif1: %fkWh", TotalEnergyConsumedTarif1 / 1000);

      TotalEnergyConsumedTarif2 = sml_data[69] << 24 | sml_data[70] << 16 | sml_data[71] << 8 | sml_data[72]; // [KWh]
      ESP_LOGI(TAG, "SML Data TotalEnergyConsumedTarif2: %fkWh", TotalEnergyConsumedTarif2 / 1000);
